...
{
    /// <summary>
    /// Unit tests for the data layer result model returning report group descriptions.
    /// </summary>
    [TestClass()]
    public class ReportDescriptionResultModelTest
    {
        #region Overhead
        ...
        {
            ReportDescriptionResultModel model = new ReportDescriptionResultModel();

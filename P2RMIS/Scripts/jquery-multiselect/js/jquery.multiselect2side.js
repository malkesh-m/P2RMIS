				...
				var htmlToAdd = 
					"<div class='ms2side__div'>" +
						...
						"<div class='ms2side__options'>" +
							...
							?
							("<button class='AddOne width40' title='Add Selected'>&rsaquo;</button>" +
							"<button class='AddAll width40' title='Add All'>&raquo;</button>" +
							"<button class='RemoveOne width40' title='Remove Selected'>&lsaquo;</button>" +
							"<button class='RemoveAll width40' title='Remove All'>&laquo;</button>")
							:
                        ("<button class='AddOne width40' title='Add Selected'>&lsaquo;</button>" +
							"<button class='AddAll width40' title='Add All'>&laquo;</button>" +
							"<button class='RemoveOne width40' title='Remove Selected'>&rsaquo;</button>" +
							"<button class='RemoveAll width40' title='Remove All'>&raquo;</button>")
							) +
						"</div>" +
						"<div class='ms2side__select clientAdded'>" +

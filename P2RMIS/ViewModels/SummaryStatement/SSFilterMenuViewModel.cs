...
{
    /// <summary>
    /// this view model is the container for the SS management filter view
    /// </summary>
    public class SSFilterMenuViewModel: SsTabMenuViewModel, ISSFilterMenuModel
    {
        #region Constructor

        public SSFilterMenuViewModel() : base()
        {

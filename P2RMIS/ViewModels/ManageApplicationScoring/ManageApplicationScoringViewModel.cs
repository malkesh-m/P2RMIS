...
namespace Sra.P2rmis.Web.ViewModels.ManageApplicationScoring
{
    public class ManageApplicationScoringViewModel : IManageApplicationScoringViewModel
    {
        #region Constructors
        /// <summary>
        /// Constructor
        /// </summary>
        public ManageApplicationScoringViewModel()
        {            
        ...
        public ManageApplicationScoringViewModel(ApplicationManagementView theApplicationBlView)
        {
            this.PollInterval = ConfigManager.ManageApplicationScoringPollingInterval;
        ...
        public ManageApplicationScoringViewModel(List<IListEntry> thePanels)
        {
            this.PollInterval = ConfigManager.ManageApplicationScoringPollingInterval;

create PROCEDURE [dbo].[uspReportMeetingPlanningSummarySubChair]
...
GRANT EXECUTE
    ON OBJECT::[dbo].[uspReportMeetingPlanningSummarySubChair] TO [NetSqlAzMan_Users]
    AS [dbo];
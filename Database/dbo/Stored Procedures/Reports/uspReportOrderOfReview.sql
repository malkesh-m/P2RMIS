...
CREATE PROCEDURE [dbo].[uspReportOrderOfReview] 
...
BEGIN
	...
	FROM      ViewApplication INNER JOIN
			  ...
			  /*******************************************************************************/
					(SELECT     ViewApplicationReviewStatus.ApplicationId, ViewApplicationReviewStatus.ReviewStatusId, ViewPanelApplication.SessionPanelId
			  ...
			  /*******************************************************************************/
					(SELECT DISTINCT t1.SessionPanelID, t1.ApplicationId, t1.LogNumber,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[uspReportOrderOfReview] TO [NetSqlAzMan_Users]
    AS [dbo];
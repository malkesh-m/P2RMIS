DECLARE @PanelApplicationId int = 288230
...
WHERE ViewApplicationStage.ReviewStageId = 3 AND ViewPanelApplication.PanelApplicationId = @PanelApplicationId)
...
INNER JOIN ViewApplicationStage ON ApplicationTemplate.ApplicationStageId = ViewApplicationStage.ApplicationStageId
INNER JOIN ViewPanelApplication ON ViewApplicationStage.PanelApplicationId = ViewPanelApplication.PanelApplicationId
WHERE ApplicationTemplate.DeletedFlag = 0 AND ViewApplicationStage.ReviewStageId = 3 AND ViewPanelApplication.PanelApplicationId = @PanelApplicationId
...
WHERE ApplicationStage.DeletedFlag = 0 AND ApplicationStage.ReviewStageId = 3 AND ViewPanelApplication.PanelApplicationId = @PanelApplicationId

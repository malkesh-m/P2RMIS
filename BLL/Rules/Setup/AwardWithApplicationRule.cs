...
namespace Sra.P2rmis.Bll.Rules.Setup
{
    ...
    ///      Cannot edit or delete an award with applications.
    /// </summary>
    internal class AwardWithApplicationRule : RuleBase<ProgramMechanism>
    {
        ...
        public AwardWithApplicationRule(IUnitOfWork unitOfWork, ProgramMechanism entity) 
        ...
        {
            //
            // All this is is just checking the number of applications on the ProgramMechanism
            // 
            if (Entity.Applications.Count() > 0)
            {
                AwardSetupBlock awardBlock = block as AwardSetupBlock;
                this.IsBroken = true;
                this.Message = (awardBlock.IsModify)? MessageService.CannotModifyAwardWithApplications: MessageService.CannotDeleteAwardWithApplications;
            }
        }
        #endregion
    }

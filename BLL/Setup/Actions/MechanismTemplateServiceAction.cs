...
namespace Sra.P2rmis.Bll.Setup.Actions
{
    ...
    /// </summary>
    internal class MechanismTemplateServiceAction : ServiceAction<MechanismTemplate>
    {
        #region Constructor & set up
        /// <summary>
        /// Constructor
        /// </summary>
        public MechanismTemplateServiceAction() { }
        #endregion
        #region Attributes
        /// <summary>
        ...
        /// <summary>
        /// This is the CRUD'ed MechanismTemplateE
        /// </summary>
        internal MechanismTemplate CRUDedEntity { get; set; }
        #endregion
        ...
        protected override void Populate(MechanismTemplate entity)
        {
        ...
        /// </summary>
        protected override void PostAdd(MechanismTemplate entity)
        {
            //
            // We just remember the MechanismTemplate we just created.
            //
        ...
        public override void PostProcess()
        {
            ...
            {
                this.EntityInfo = new List<IEntityInfo>() { new MechanismTemplateEntityInfo(this.CRUDedEntity.MechanismTemplateId) };
            }
        }
        #endregion
    }
